...
public class JGraficoMaisAssistidos extends JDialog {
	...
	public static void main(String[] args) {
		try {
			JGraficoMaisAssistidos dialog = new JGraficoMaisAssistidos();
	 ...
	 * Create the dialog.
	 */
	public JGraficoMaisAssistidos() {
		setTitle("Visualizações - Dashboard");
      ...
      //  contentPanel_1.add(lblNewLabel);
        ...
        cbmFiltro.setModel(new DefaultComboBoxModel(new String[] {"M\u00EAs", "Ano"}));
	...
	private DefaultCategoryDataset createDatasetMes() {
	       ...
	       XYSeries series = new XYSeries("Quantidade de Visualizações");
	       series.add(1.0, 2.0);
	       series.add(3.0, 10.0);
	       ...
	       List<String> valoresMeses = controlCliente.SelecionarMaisAcessos();
	...
	private DefaultCategoryDataset createDatasetAno() {
	       ...
	       XYSeries series = new XYSeries("Usuários Cadastrados - Ano");
	       series.add(1.0, 2.0);
	       series.add(3.0, 10.0);
	       ...
	       List<String> valoresMeses = controlCliente.UsuarioQtdAno();
	       
	       ds.addValue(Double.parseDouble(valoresMeses.get(0)), "teste", "2015");
	       ds.addValue(Double.parseDouble(valoresMeses.get(1)), "teste", "2016");
	       ds.addValue(Double.parseDouble(valoresMeses.get(2)), "teste", "2017");
	       ds.addValue(Double.parseDouble(valoresMeses.get(3)), "teste", "2018");
	       ds.addValue(Double.parseDouble(valoresMeses.get(4)), "teste", "2019");
	 ...
	 private void FiltroAno(){
	    ...
	    public JPanel createDemoPanelMes() {
	        ...
	        JFreeChart chart = ChartFactory.createLineChart("Visualizações", "Mês", "Quantidade", createDatasetMes(), PlotOrientation.VERTICAL, true, true, false);
	    ...
	    public JPanel createDemoPanelAno() {
	        //JFreeChart chart = createChart(createDataset());
	        JFreeChart chart = ChartFactory.createLineChart("Usuários Cadastrados", "Ano", "Quantidade", createDatasetAno(), PlotOrientation.VERTICAL, true, true, false);
	        CategoryPlot plot = (CategoryPlot) chart.getPlot();
	        CategoryItemRenderer renderer = new DefaultCategoryItemRenderer();
