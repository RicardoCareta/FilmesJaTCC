...
public class JGraficoUsuario extends JDialog {
	...
	public static void main(String[] args) {
		try {
			JGraficoUsuario dialog = new JGraficoUsuario();
	...
	public JGraficoUsuario() {
		setTitle("Usu\u00E1rios Cadastrados - Dashboard");
	...
	private DefaultCategoryDataset createDatasetMes() {
	       ...
	       XYSeries series = new XYSeries("Usuários Cadastrados - Mês");
	       series.add(1.0, 2.0);
	       series.add(3.0, 10.0);
	       ...
	       List<String> valoresMeses = controlCliente.UsuarioQtd();
	...
	private DefaultCategoryDataset createDatasetAno() {
	 ...
	 private void FiltroAno(){
	    ...
	    public JPanel createDemoPanelMes() {
	        ...
	        JFreeChart chart = ChartFactory.createLineChart("Usuários Cadastrados", "Mês", "Quantidade", createDatasetMes(), PlotOrientation.VERTICAL, true, true, false);
